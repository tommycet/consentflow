/**
 * SVG icon components — replaces all emoji icons (anti-slop requirement).
 * Inline SVGs, no external dependencies, consistent 20x20 default size.
 */
...
const cls = (className?: string) => className ?? 'w-5 h-5';

export function IconShield({ className, size }: IconProps) {
  return (
    <svg className={cls(className)} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
export function IconCheck({ className, size }: IconProps) {
  return (
    <svg className={cls(className)} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function IconDocs({ className, size }: IconProps) {
  return (
    <svg className={cls(className)} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
